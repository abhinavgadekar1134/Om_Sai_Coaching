        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 text-slate-600">
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <a href="https://www.youtube.com/@omsaicoachingclasses2765" className="w-10 h-10 bg-white border border-slate-200 rounded-full flex items-center justify-center hover:bg-red-600 hover:text-white hover:border-red-600 transition-all">
                <YouTube size={20} />
              </a>
